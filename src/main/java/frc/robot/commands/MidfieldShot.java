...
public class MidfieldShot extends SequentialCommandGroup {
  /** Creates a new NearSpeakerScore. */
  public MidfieldShot(Elevator elevator, Intake intake, Pivot pivot, Shooter shooter) {
    addCommands(
      ...
      new InstantCommand(() -> pivot.setPivotAngle(Rotation2d.fromDegrees(50.0))), //TODO: Tune this angle.
        
      new WaitUntilCommand(() -> pivot.angleErrorDegrees() < 1.5 && elevator.reachedSetpoint() && shooter.getShooterRPM() > 2500.0).withTimeout(1.0),
