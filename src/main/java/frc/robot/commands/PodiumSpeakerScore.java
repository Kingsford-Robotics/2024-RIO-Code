...
public class PodiumSpeakerScore extends SequentialCommandGroup {
  /** Creates a new NearSpeakerScore. */
  public PodiumSpeakerScore(Elevator elevator, Intake intake, Pivot pivot, Shooter shooter) {
    addCommands(
      ...
      new InstantCommand(() -> pivot.setPivotAngle(Rotation2d.fromDegrees(35.0))), //TODO: Tune this angle.
